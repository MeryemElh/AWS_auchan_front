...
(async function() {
    ...
    function createChart1(json) {
        ...
        new (0, _autoDefault.default)(document.getElementById("chart1"), {
            type: "bar",
            data: {
    ...
    var chart2_data = [];
    fetch(backend_host + "getChart2Data").then((response)=>response.json()).then((json)=>{
        createChart2(json);
    });
    function createChart2(json) {
        chart2_data = json;
        new (0, _autoDefault.default)(document.getElementById("chart2"), {
            type: "pie",
            data: {
    ...
    function createChart3(json) {
        ...
        new (0, _autoDefault.default)(document.getElementById("chart3"), {
            type: "radar",
            options: {
                elements: {
                    line: {
    ...
    var chart4_data = [];
    fetch(backend_host + "getChart4Data").then((response)=>response.json()).then((json)=>{
        createChart4(json);
    });
    function createChart4(json) {
        chart4_data = json;
        new (0, _autoDefault.default)(document.getElementById("chart4"), {
            type: "polarArea",
            data: {
